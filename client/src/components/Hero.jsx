...
const Hero = () => {
  ...
  const onSearch = async (e) => {
    ...
    // Add destination to searchedCities , max 3 recent seacrhed Cities
    setSearchedCities((prevSerchedCities) => {
        const updatedSearchedCities = [...prevSerchedCities, destination]
