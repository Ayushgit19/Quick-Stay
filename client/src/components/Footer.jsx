  ...
  return (
    <div className='bg-[#F6F9FC] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                ...
                <div>
                    <p className='font-playfair text-lg text-gray-800'>QuickStay</p>
                ...
                <div className='max-w-80'>
                    ...
                    <div className='flex items-center mt-4'>
                        ...
                        <button className='flex items-center justify-center bg-black h-9 w-9 aspect-square rounded-r cursor-pointer '>
                            {/* Arrow icon */}
                            <img src={assets.arrowIcon} alt="arrow-icon" className='invert w-3.5 hover:translate-x-0.5 transition-all'/>
                        </button>
                    </div>
                </div>
            </div>
