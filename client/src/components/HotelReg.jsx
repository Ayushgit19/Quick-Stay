      ...
      <form onSubmit={onSubmitHandler} onClick={(e) => e.stopPropagation()} className="flex bg-white rounded-xl max-w-4xl max-md:mx-2">
        ...
        <div className="relative flex flex-col items-center md:w-1/2 p-8 md:p-10">
          ...
          <div className="w-full mt-4 max-w-60 mr-auto">
            ...
            <select
              id="city"
              className="border border-gray-200 rounded w-full px-2 py-2.5 mt-1 outline-indigo-500 font-light"
          ...
          <button className="bg-indigo-500 hover:bg-indigo-600 transition-all text-white mr-auto px-6 py-2 cursor-pointer mt-6">
            Register
          </button>
        </div>
      </form>
